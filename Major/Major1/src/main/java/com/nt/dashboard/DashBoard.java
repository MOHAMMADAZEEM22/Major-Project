...
public class DashBoard extends HttpServlet {
    public void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        if (userRole != null && userRole.equalsIgnoreCase("teacher")) {
            ...
            pw.println("<ul>");
            pw.println("<li><a href='CreateCourseServlet' class='button'>Create Course</a></li>");
            pw.println("<li><a href='ManageAssignmentsServlet' class='button'>Manage Assignments</a></li>");
            pw.println("<li><a href='GradebookServlet' class='button'>Manage Grades</a></li>");
            pw.println("<li><a href='DiscussionServlet' class='button'>Manage Discussions</a></li>");
            ...
            pw.println("<ul>");
            pw.println("<li><a href='EnrollCourseServlet' class='button'>Enroll in Course</a></li>");
            pw.println("<li><a href='SubmitAssignmentServlet' class='button'>Submit Assignments</a></li>");
            pw.println("<li><a href='ViewGradesServlet' class='button'>View Grades</a></li>");
            pw.println("<li><a href='ParticipateDiscussionServlet' class='button'>Participate in Discussions</a></li>");
